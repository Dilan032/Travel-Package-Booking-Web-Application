          ...
          <form action="{{route('admin.updateTravelPackage',$travelPackage->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col">
                        <div class="row ">
                            <div class="col">
                                ...
                                <select id="inputState" value="{{old('package_type',$travelPackage->package_type)}}" name="package_type" class="form-select">
                                    <option > {{$travelPackage->package_type}} </option>
                        ...
                        <div class="row ">
                            ...
                            <div class="col">
                                ...
                                <select id="inputState" value="{{old('duration_type',$travelPackage->duration_type)}}" name="duration_type" class="form-select">
                                    <option > {{$travelPackage->duration_type}} </option>
                                    <option > Days </option>
                                    <option> Weeks </option>
                                </select>
                            </div>
             ...
             <div class="row bg-for-price mt-4">
                ...
                <div class="row g-3 fw-bold">
                    <div class="col">
                        ...
                        <input type="text" name="service_fee" placeholder="$ 0.00" value="{{old('service_fee',$travelPackage->service_fee)}}" class="form-control" style="text-align: right;">
                    </div>
                    <div class="col">
                        <label for="inputCity" class="form-label">Booking Fee</label>
                        <input type="text" name="booking_fee" placeholder="$ 0.00" value="{{old('booking_fee',$travelPackage->booking_fee)}}" class="form-control" style="text-align: right;">
                    </div>
                </div>
            </div> 
            </div>
            ...
            <div class="row mt-4 bg-for-list" style="margin-left: 1px;">
                ...
                <div class="col-md-6">  
                    ...
                    <textarea name="Excludes_things" value="{{old('Excludes_things')}}" class="form-control" id="Excludes_things" rows="5"> {{old('Excludes_things' ,$travelPackage->Excludes_things)}} </textarea>
                </div>
              </div>
